...
namespace TAssistant
{
    public partial class Form1 : Form
    {
        ...
        {
            //int id = Convert.ToInt32(textBoxUname.Text);
           
            String logEmail = textBoxEmail.Text;
            String pass = textBoxPass.Text;
            admin.CheckAdmin(logEmail, pass);
            if (MyVar.isLogIn)
            {
            ...
            {
                MessageBox.Show("Log in failed.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
