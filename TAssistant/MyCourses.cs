...
namespace TAssistant
{
    public partial class MyCourses : Form
    {
        ...
        private void MyCourses_Load(object sender, EventArgs e)
        {
            ...
            command.CommandText = "SELECT * FROM mycourse WHERE adminId = '" + adid + "'";
            DataTable data = new DataTable();
            SqlDataAdapter adapter = new SqlDataAdapter(command);
            adapter.Fill(data);
            dataGridViewMyCourses.DataSource = data;
        }
        ...
        private void AddCoursebtn_Click(object sender, EventArgs e)
        {
            ...
            string yearSem = textBoxYearSem.Text;
            if (courseNo == "" || dept == "" || courseName == "" || yearSem == "")
            {
                MessageBox.Show("You cannot put blank values.Please fill all fields.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
                AdminDAO addCourse = new AdminDAO();
                int adminId = MyVar.uid;
                addCourse.AddCourse(new AdminDTO(courseNo,courseName, dept,yearSem, adminId));
        ...
        private void DelCourseBtn_Click(object sender, EventArgs e)
        {
            ...
            if (courseNo == "")
            {
                MessageBox.Show("You have to put courseNo.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
                AdminDAO delcourse = new AdminDAO();
                int adminId = MyVar.uid;//static value from my var class
                delcourse.DeleteCourse(new AdminDTO(courseNo, courseName, dept, yearSem, adminId));
