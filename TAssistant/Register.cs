...
namespace TAssistant
{
    public partial class Register : Form
    {
        ...
        private void registerbtn_Click(object sender, EventArgs e)
        {
            ...
            String conPass = textBoxConPass.Text;
            String contact = textBoxContact.Text;

            AdminDAO newAdmin = new AdminDAO();
            if (uname == "" || email == "" || pass == "" || conPass == "" || contact == "" )
            {
            ...
            else
            {
                ...
                else
                {
                    if (pass == conPass)
                    {
                        newAdmin.CreateAdmin(new AdminDTO(uname, email, pass, contact));
                        textBoxUname.Text = "";
                        textBoxPass.Text = "";
                        textBoxConPass.Text = "";
                        textBoxContact.Text = "";
                    ...
                    {
                        MessageBox.Show("Passwords did not match", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
